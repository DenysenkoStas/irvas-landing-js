...
var changeModalState = function changeModalState(state) {
  ...
  Object(_checkNumInputs__WEBPACK_IMPORTED_MODULE_1__["default"])('#height'); // запись выбора в стейт
  ...
  bindActionToElems('click', windowForm, 'form'); // запись формы балкона

  bindActionToElems('input', windowHeight, 'height'); // запись высоты

  bindActionToElems('input', windowWidth, 'width'); // запись ширины

  bindActionToElems('change', windowType, 'type'); // запись типа остекления

  bindActionToElems('change', windowProfile, 'profile'); // запись профиля
};
...
var checkNumInputs = function checkNumInputs(selector) {
  var numInputs = document.querySelectorAll(selector); // валидация - ввод только чисел
...
var forms = function forms(state) {
  var form = document.querySelectorAll('form'),
      inputs = document.querySelectorAll('input'); // валидация номера телефона (ввод только чисел)
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      e.preventDefault(); // создание блока со статусом

      var statusMessage = document.createElement('div');
      statusMessage.classList.add('status');
      item.appendChild(statusMessage); // сбор данных в объект
...
var images = function images() {
  ...
  imgPopup.style.display = 'none'; // ограничение размера изображений
  ...
  workSection.addEventListener('click', function (e) {
    e.preventDefault();
    var target = event.target; // открытие
...
var modals = function modals() {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    var trigger = document.querySelectorAll(triggerSelector),
        ...
        windows = document.querySelectorAll('[data-modal]'); // триггер открытия
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        document.body.style.overflow = 'hidden'; // document.body.classList.add('modal-open'); // использование класса Bootstrap
      });
    }); // триггер закрытия
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  ...
  var header = document.querySelector(headerSelector),
      ...
      content = document.querySelectorAll(contentSelector); // скрытие контента табов и удаление активного класса
  ...
  } // отображение контента таба и добавление активного класса
  ...
  hideTabContent();
  showTabContent(); // переключение табов по клику
